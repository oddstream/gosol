...
It currently only plays a few variants (Australian, Klondike (draw 1 and draw 3), Freecell, Limited, Spider1, Spider2). Use a command line flag (eg -v=Limited) to set the variant.

It currently has no user interface other than U - undo, N - new deal, R - restart deal.

It currently doesn't detect a completed game, or do any fancy highlighting of moveable cards, or automoving of cards, or recording of the player's statistics.
