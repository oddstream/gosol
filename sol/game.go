...
var TheUserData = &UserData{Game: "Solitaire", Variant: "Klondike", HighlightMovable: true, PowerMoves: true, SingleTap: true, CardStyle: "scaled", CardBackPattern: "FlowerBlue", CardBackColor: "CornflowerBlue"}
