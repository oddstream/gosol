...
var Variants = map[string]VariantInfo{
	...
	"Canfield": {
		...
		Piles: []PileInfo{
			...
			{"Waste", 2, 1, "Waste", map[string]string{"Build": "15", "Drag": "15"}},
			{"Foundation", 4, 1, "None", map[string]string{"Build": "21", "Drag": "0", "Deal": "u"}},
			{"Foundation", 5, 1, "None", map[string]string{"Build": "21", "Drag": "0"}},
			{"Foundation", 6, 1, "None", map[string]string{"Build": "21", "Drag": "0"}},
			{"Foundation", 7, 1, "None", map[string]string{"Build": "21", "Drag": "0"}},
			{"Reserve", 1, 2, "Down", map[string]string{"Build": "0", "Drag": "15", "Deal": "ddddddddddddu"}},
			{"Tableau", 4, 2, "Down", map[string]string{"Build": "42", "Drag": "42", "AutoFillFrom": "Reserve", "Deal": "u"}},
			{"Tableau", 5, 2, "Down", map[string]string{"Build": "42", "Drag": "42", "AutoFillFrom": "Reserve", "Deal": "u"}},
			{"Tableau", 6, 2, "Down", map[string]string{"Build": "42", "Drag": "42", "AutoFillFrom": "Reserve", "Deal": "u"}},
			{"Tableau", 7, 2, "Down", map[string]string{"Build": "42", "Drag": "42", "AutoFillFrom": "Reserve", "Deal": "u"}},
		},
	},
	"Freecell": {
