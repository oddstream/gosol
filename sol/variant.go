...
var Variants = map[string]VariantInfo{
	...
	"Spider": {
		...
		Piles: []PileInfo{
			...
			{"FoundationSpider", 3, 1, "None", map[string]string{"Accept": "1", "Build": "22", "Drag": "0"}},
			{"FoundationSpider", 4, 1, "None", map[string]string{"Accept": "1", "Build": "22", "Drag": "0"}},
			{"FoundationSpider", 5, 1, "None", map[string]string{"Accept": "1", "Build": "22", "Drag": "0"}},
			{"FoundationSpider", 6, 1, "None", map[string]string{"Accept": "1", "Build": "22", "Drag": "0"}},
			{"FoundationSpider", 7, 1, "None", map[string]string{"Accept": "1", "Build": "22", "Drag": "0"}},
			{"FoundationSpider", 8, 1, "None", map[string]string{"Accept": "1", "Build": "22", "Drag": "0"}},
			{"FoundationSpider", 9, 1, "None", map[string]string{"Accept": "1", "Build": "22", "Drag": "0"}},
			{"FoundationSpider", 10, 1, "None", map[string]string{"Accept": "1", "Build": "22", "Drag": "0"}},
