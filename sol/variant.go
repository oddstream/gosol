...
var Variants = map[string]VariantInfo{
	...
	"Cruel": {
		...
		Piles: []PileInfo{
			...
			{"Tableau", 0, 1, "Down", 22, 22, 0, map[string]string{"Accept": "99", "Deal": "uuuu"}},
			{"Tableau", 1, 1, "Down", 22, 22, 0, map[string]string{"Accept": "99", "Deal": "uuuu"}},
			{"Tableau", 2, 1, "Down", 22, 22, 0, map[string]string{"Accept": "99", "Deal": "uuuu"}},
			{"Tableau", 3, 1, "Down", 22, 22, 0, map[string]string{"Accept": "99", "Deal": "uuuu"}},
			{"Tableau", 4, 1, "Down", 22, 22, 0, map[string]string{"Accept": "99", "Deal": "uuuu"}},
			{"Tableau", 5, 1, "Down", 22, 22, 0, map[string]string{"Accept": "99", "Deal": "uuuu"}},
			{"Tableau", 6, 1, "Down", 22, 22, 0, map[string]string{"Accept": "99", "Deal": "uuuu"}},
			{"Tableau", 7, 1, "Down", 22, 22, 0, map[string]string{"Accept": "99", "Deal": "uuuu"}},
			{"Tableau", 8, 1, "Down", 22, 22, 0, map[string]string{"Accept": "99", "Deal": "uuuu"}},
			{"Tableau", 9, 1, "Down", 22, 22, 0, map[string]string{"Accept": "99", "Deal": "uuuu"}},
			{"Tableau", 10, 1, "Down", 22, 22, 0, map[string]string{"Accept": "99", "Deal": "uuuu"}},
			{"Tableau", 11, 1, "Down", 22, 22, 0, map[string]string{"Accept": "99", "Deal": "uuuu"}},
		},
	},
	"Duchess": {
