...
var Variants = map[string]VariantInfo{
	...
	"EasyWin": {
		...
		Piles: []PileInfo{
			...
			{"Tableau", 11, 1, "Down", 42, 42, 0, map[string]string{"Deal": "uu"}},
			{"Tableau", 12, 1, "Down", 42, 42, 0, map[string]string{"Deal": "uu"}},
			{"Tableau", 0, 4, "Down", 42, 42, 0, map[string]string{"Deal": "du"}},
			{"Tableau", 1, 4, "Down", 42, 42, 0, map[string]string{"Deal": "du"}},
			{"Tableau", 2, 4, "Down", 42, 42, 0, map[string]string{"Deal": "u"}},
			{"Tableau", 3, 4, "Down", 42, 42, 0, map[string]string{"Deal": "u"}},
			{"Tableau", 4, 4, "Down", 42, 42, 0, map[string]string{"Deal": "u"}},
			{"Tableau", 5, 4, "Down", 42, 42, 0, map[string]string{"Deal": "u"}},
			{"Tableau", 6, 4, "Down", 42, 42, 0, map[string]string{"Deal": "u"}},
			{"Tableau", 7, 4, "Down", 42, 42, 0, map[string]string{"Deal": "u"}},
			{"Tableau", 8, 4, "Down", 42, 42, 0, map[string]string{"Deal": "u"}},
			{"Tableau", 9, 4, "Down", 42, 42, 0, map[string]string{"Deal": "u"}},
			{"Tableau", 10, 4, "Down", 42, 42, 0, map[string]string{"Deal": "u"}},
			{"Tableau", 11, 4, "Down", 42, 42, 0, map[string]string{"Deal": "u"}},
			{"Tableau", 12, 4, "Down", 42, 42, 0, map[string]string{"Deal": "u"}},
		},
	},
	"Fortune's Favor": {
...
Making four spaces pretty much guarantees a win. A good tactic is to find columns, all of whose cards can be built on others.`,
	...
	"Red and Black": {
		...
		Piles: []PileInfo{
			{"Stock", 0, 0, "None", 0, 15, 0, map[string]string{"Packs": "2", "Target": "Waste", "Recycles": "0"}},
			{"Waste", 1, 0, "Waste", 15, 15, 1, nil},
			{"Foundation", 3, 0, "None", 41, 0, 0, map[string]string{"Deal": "1"}},
			{"Foundation", 4, 0, "None", 41, 0, 0, map[string]string{"Deal": "1"}},
			{"Foundation", 5, 0, "None", 41, 0, 0, map[string]string{"Deal": "1"}},
			{"Foundation", 6, 0, "None", 41, 0, 0, map[string]string{"Deal": "1"}},
			{"Foundation", 7, 0, "None", 41, 0, 0, map[string]string{"Deal": "1"}},
			{"Foundation", 8, 0, "None", 41, 0, 0, map[string]string{"Deal": "1"}},
			{"Foundation", 9, 0, "None", 41, 0, 0, map[string]string{"Deal": "1"}},
			{"Foundation", 10, 0, "None", 41, 0, 0, map[string]string{"Deal": "1"}},
			{"Tableau", 3, 1, "Down", 42, 42, 1, map[string]string{"AutoFillFrom": "Waste,Stock", "Deal": "u"}},
			{"Tableau", 4, 1, "Down", 42, 42, 1, map[string]string{"AutoFillFrom": "Waste,Stock", "Deal": "u"}},
			{"Tableau", 5, 1, "Down", 42, 42, 1, map[string]string{"AutoFillFrom": "Waste,Stock", "Deal": "u"}},
			{"Tableau", 6, 1, "Down", 42, 42, 1, map[string]string{"AutoFillFrom": "Waste,Stock", "Deal": "u"}},
			{"Tableau", 7, 1, "Down", 42, 42, 1, map[string]string{"AutoFillFrom": "Waste,Stock", "Deal": "u"}},
			{"Tableau", 8, 1, "Down", 42, 42, 1, map[string]string{"AutoFillFrom": "Waste,Stock", "Deal": "u"}},
			{"Tableau", 9, 1, "Down", 42, 42, 1, map[string]string{"AutoFillFrom": "Waste,Stock", "Deal": "u"}},
			{"Tableau", 10, 1, "Down", 42, 42, 1, map[string]string{"AutoFillFrom": "Waste,Stock", "Deal": "u"}},
		},
	},
	"Ripple Fan": {
