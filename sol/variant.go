...
var Variants = map[string]VariantInfo{
	...
	"EasyWin": {
		...
		Piles: []PileInfo{
			...
			{"Tableau", 2, 5, "Down", map[string]string{"Build": "42", "Drag": "42"}},
			{"Tableau", 3, 5, "Down", map[string]string{"Build": "42", "Drag": "42"}},
			{"Tableau", 4, 5, "Down", map[string]string{"Build": "42", "Drag": "42"}},
			...
			{"Tableau", 8, 5, "Down", map[string]string{"Build": "42", "Drag": "42", "Deal": "du"}},
			{"Tableau", 9, 5, "Down", map[string]string{"Build": "42", "Drag": "42", "Deal": "du"}},
		},
	},
	"Freecell": {
