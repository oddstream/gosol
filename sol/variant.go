...
var Variants = map[string]VariantInfo{
	...
	"Scorpion": {
		...
		Piles: []PileInfo{
			{"StockScorpion", 1, 1, "None", map[string]string{"Build": "0", "Drag": "15"}},
			...
			{"Tableau", 1, 2, "Down", map[string]string{"Accept": "13", "Build": "22", "Drag": "15", "Deal": "ddduuuu"}},
			{"Tableau", 2, 2, "Down", map[string]string{"Accept": "13", "Build": "22", "Drag": "15", "Deal": "ddduuuu"}},
			{"Tableau", 3, 2, "Down", map[string]string{"Accept": "13", "Build": "22", "Drag": "15", "Deal": "ddduuuu"}},
			{"Tableau", 4, 2, "Down", map[string]string{"Accept": "13", "Build": "22", "Drag": "15", "Deal": "uuuuuuu"}},
			{"Tableau", 5, 2, "Down", map[string]string{"Accept": "13", "Build": "22", "Drag": "15", "Deal": "uuuuuuu"}},
			{"Tableau", 6, 2, "Down", map[string]string{"Accept": "13", "Build": "22", "Drag": "15", "Deal": "uuuuuuu"}},
			{"Tableau", 7, 2, "Down", map[string]string{"Accept": "13", "Build": "22", "Drag": "15", "Deal": "uuuuuuu"}},
		},
	},
	"Spider1": {
	...
	"Wasp": {
		...
		Piles: []PileInfo{
			...
			{"FoundationSpider", 6, 1, "None", map[string]string{"Accept": "13", "Build": "22", "Drag": "0"}},
			{"FoundationSpider", 7, 1, "None", map[string]string{"Accept": "13", "Build": "22", "Drag": "0"}},
			{"Tableau", 1, 2, "Down", map[string]string{"Build": "22", "Drag": "15", "Deal": "ddduuuu"}},
			{"Tableau", 2, 2, "Down", map[string]string{"Build": "22", "Drag": "15", "Deal": "ddduuuu"}},
			{"Tableau", 3, 2, "Down", map[string]string{"Build": "22", "Drag": "15", "Deal": "ddduuuu"}},
			{"Tableau", 4, 2, "Down", map[string]string{"Build": "22", "Drag": "15", "Deal": "uuuuuuu"}},
			{"Tableau", 5, 2, "Down", map[string]string{"Build": "22", "Drag": "15", "Deal": "uuuuuuu"}},
			{"Tableau", 6, 2, "Down", map[string]string{"Build": "22", "Drag": "15", "Deal": "uuuuuuu"}},
			{"Tableau", 7, 2, "Down", map[string]string{"Build": "22", "Drag": "15", "Deal": "uuuuuuu"}},
		},
	},
}
